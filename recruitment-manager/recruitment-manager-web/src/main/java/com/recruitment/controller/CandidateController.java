...
public class CandidateController {
    ...
    @ResponseBody
    public RecruitmentResult add(Candidate candidate,String username,String password,String email){
        
        RecruitmentResult result = candidateService.creatcandidate(candidate,username,password,email);
