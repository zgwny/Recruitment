...
public class JobController {
    ...
    public EasyUIDataGridResult list(Integer page, Integer rows){
        ...
        EasyUIDataGridResult result = jobService.getjobList(page, rows);
    ...
    @ResponseBody
    public RecruitmentResult add(Job job,String requirement,String description){
        
        RecruitmentResult result = jobService.creatjob(job,requirement,description);
