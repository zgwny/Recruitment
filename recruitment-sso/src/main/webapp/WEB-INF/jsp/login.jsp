...
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 400px; position: absolute; left: -44px; top: -44px; background: url(/images/ad4.jpg) 50px 45px no-repeat;">
			</div>
            <div class="form ">
